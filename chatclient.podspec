...
Pod::Spec.new do |spec|
  ...
  spec.description  = 'A short description of chatclient. Chat Client for Relay'
  spec.homepage     = "http://EXAMPLE/chatclient"
  ...
  spec.author             = { "ParvinderjitSF" => "parvinder.singh@sourcefuse.com" }
  # Or just: spec.author    = "ParvinderjitSF"
  # spec.authors            = { "ParvinderjitSF" => "parvinder.singh@sourcefuse.com" }
  # spec.social_media_url   = "https://twitter.com/ParvinderjitSF"
